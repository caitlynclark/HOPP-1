...
def hopp_for_Nome(site, scenario, technologies, wind_size_mw, solar_size_mw, 
                storage_size_mw, storage_size_mwh, storage_hours, wind_cost_kw, 
                solar_cost_kw, storage_cost_kw, storage_cost_kwh, kw_continuous, 
                load, custom_powercurve, interconnection_size_mw, existing_wind_production, 
    ...
    combined_pv_wind_power_production_hopp = existing_wind_production #hybrid_plant.grid._system_model.Outputs.system_pre_interconnect_kwac[0:8759] #
