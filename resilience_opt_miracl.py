...
forced_wind_size = 1.98
forced_solar_size = 5
forced_storage_size_mw = 1
forced_storage_size_mwh = 4
...
force_cat_size_kw=num_cat_gen * 2825 #5650 #only used if generator type is 'CAT' or 'Both'
...
if save_outputs:
    ...
    save_all_runs_df.to_csv(os.path.join(results_dir, "Algona_OECD_WithAssets.csv"))
